        ...
        <div class="row">
            <div class="span4">
                <div class="alert alert-info">
                    ...
                    <p><a href="<?php echo site_url('ciu/download/' . $flight->id) ?>" class="btn btn-large btn-primary">DOWNLOAD HERE</a></p>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            <?php foreach ($passengers as $r): ?>
                                <tr id="row-<?php echo $r->id ?>" class="cc">
                                    ...
                                    <td><a href="<?php echo site_url('ciu/ajax_manifest/' . $r->id) ?>" class="btn btn-small btn-primary save-manifest" rel-data="<?php echo $r->id ?>">save</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
